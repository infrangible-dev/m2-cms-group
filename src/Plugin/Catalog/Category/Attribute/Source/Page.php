...
namespace Infrangible\CmsGroup\Plugin\Catalog\Category\Attribute\Source;
...
class Page
{
    ...
    /**
     * @param \Magento\Catalog\Model\Category\Attribute\Source\Page $subject
    ...
    public function aroundGetAllOptions(
        \Magento\Catalog\Model\Category\Attribute\Source\Page $subject,
        callable $proceed
    ): array {
        ...
        array_unshift($result, ['value' => '', 'label' => __('Please select a static block.')]);
